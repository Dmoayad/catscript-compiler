...
public class ComparisonExpression extends Expression {
    ...
    public Object evaluate(CatscriptRuntime runtime) {
        ...
        // compare each values to each other.
    ...
    public void compile(ByteCodeGenerator code) {
        ...
        if(isGreater()) {
            code.addJumpInstruction(Opcodes.IF_ICMPLE, setAsFalse);
        } else if (isGreaterThanOrEqual()) {
            code.addJumpInstruction(Opcodes.IF_ICMPLT, setAsFalse);
        } else if(isLessThan()){
            code.addJumpInstruction(Opcodes.IF_ICMPGE, setAsFalse);
        } else {
            code.addJumpInstruction(Opcodes.IF_ICMPGT, setAsFalse);
        }
